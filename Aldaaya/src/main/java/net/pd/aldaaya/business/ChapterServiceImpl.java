...
public class ChapterServiceImpl implements ChapterService {
	...
	@Override
	public List<Chapter> search(String queryString) throws AldaayaException {
		try { 
			
			
			return chapterDao.findByNameContainingIgnoreCaseOrDescriptionContainingIgnoreCase(queryString,queryString);
//					return chapterDao.findByNameInIgnoreCase
		} catch (Exception e) {
			throw new AldaayaException(e);
		}
	}
